...
function setup(){
    ...
    polygon = new Polygon(100, 450, 50, PI/4);
    sling = new Slingshot(polygon.body, {x : 135, y : 420});
    ...
    //EIGHTH ROW
    block40 = new Block(685, 144, 40, 40);
    block41 = new Block(725, 144, 40, 40);
    block42 = new Block(765, 144, 40, 40);
    //NINTH ROW
    block43 = new Block(705, 102, 40, 40);
    block44 = new Block(745, 102, 40, 40);
    //TENTH ROW
    block45 = new Block(725, 59, 40, 40);
...
function txt(){
    textSize(25);
    text("Drag the mouse over the Launcher and aim for the blocks!", 35, 40);
}